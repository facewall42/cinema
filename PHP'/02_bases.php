...
?>
                        ...
                        <div class="alert alert-primary w-50">
                        <?php
                                print "je suis un texte en PHP dans une instruction print";
...
?>
            ...
            <div class="col-sm-12">
                    ...
                    <p>Dans une première variable je stocke le mot 'Bonjour', et dans une deuxième le mot 'Madame', afin d'afficher la phrase compléte je concaténe les deux variables avec un point (.) (ex : voir le code sur VS code)</p>
                    <div class="alert alert-primary w-50">
                            <?php 
                            echo "Bonjour"." Madame\n";
                            $mot1 = "Bonjour";
            ...
            <div class="col-sm-12">
                ...
                <p>Chaque variable posséde un identifiant particulier qui commence toujours par le caractère dollar <span>$</span>.</p>
                ...
                <ul>
                    ...
                    <li>Le nom commence par un caractère alphabétique, pris dans les ensembles [A_Z] ou [a_z] ou un underscore <span>_</span>(à éviter car en PHP existent des variables prédéfinies et qui commencent par le underscore)</li>
            ...
            <div class="col-sm-12">
                <h2>9- Les opérateurs d'affectation combinée numérique</h2>
            ...
            <div class="col-sm-12">
                ...
                <p>Une constante permet de conserver une valeur sauf que celle-ci ne peut pas changer. C'est à dire qu'on ne pourra pas la modifier durant l'exécution du script. Utile par exemple pour conserver les paramètres de connexion à la BDD de façon certaine. </p>
