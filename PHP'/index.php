    ...
    <section class="row mt-5">
      ...
      <div class="col-12 mt-5">  
        <div class="alert alert-secondary">
          ...
          <ul>
            <li>À partir du terminal : après avoir installer PHP sur la machine on peut lancer les applications avec la ligne de commande <span>php -S localhost:numéroduport (ex: 8000)</span></li>
