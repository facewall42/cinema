    ...
    <div class="col-sm-12 col-md-6 d-flex flex-column mt-5 pe-3">  
        ...
        ?>
                        ...
                        <td><?= substr(ucfirst($categorie['description']),0,50) ?></td><!-- une majuscule sur la premère lettre et on extrait que les 100 premiers caracteres--> 
                            ...
                            <td class="text-center" onclick="return(confirm('Êtes-vous sûr de vouloir supprimer cette categorie ?'))"
><a href="categories.php?action=delete&id=<?= $categorie['id_category'] ?>" ><i class="bi bi-trash3-fill"></i></a></td>
