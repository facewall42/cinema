...
$paragraphe = 'Nos 15 dernières annonces immobilières';
// Récupération des 15 derniers annonces immobilières dans le sens inverse car on n'a que 30 annonces au total. Sinon une requete sql peut etre faite comme : "SELECT * FROM annonces ORDER BY date_creation DESC LIMIT 15;" :
$annonces = array_reverse(array_slice(getAdverts(), -15));
